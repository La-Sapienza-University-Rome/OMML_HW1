...
df = pd.read_csv('JeDiS_HW1/data/DATA.csv')
...
# Set to True if we want to perform the full grid search using 5-Fold Cross Validation
...
if full_grid_search:
    ...
    funcArgs_train = [X, y, sigma, N, rho]
    ...
    print('Optimization solver chosen:', method)
    ...
    with open('bonus_prediction.pickle', 'wb') as handle:
